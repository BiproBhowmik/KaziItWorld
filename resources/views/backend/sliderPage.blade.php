						...
						<div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-12">
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">Slider Value</th>
				...
				<form enctype="multipart/form-data" action="{{ route('addSlider') }}" method="POST" id="commonAddForm">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input id="commonDiscription" name="commonDiscription" type="text" class="form-control" placeholder="Slider Discription">
						</div>

						<div class="form-group">

							<label for="langName">Slider Value</label>
							<input id="commonValue" name="commonValue" type="text" class="form-control" placeholder="Slider Value">
						</div>
