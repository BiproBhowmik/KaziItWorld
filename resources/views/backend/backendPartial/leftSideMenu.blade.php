                ...
                <div class="sidebar-inner slimscrollleft">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>{{-- <a href="{{ route('logout') }}"><i class="md md-settings-power"></i> Logout</a> --}}
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('ourClints') }}" class="waves-effect"><i class="md md-event"></i><span> Our Clints </span></a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('testimonial') }}" class="waves-effect"><i class="md md-event"></i><span> Testimonial </span></a>
                            </li>
