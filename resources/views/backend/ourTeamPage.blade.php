						...
						<div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-12">
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">Facebook</th>
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">Twiter</th>
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">Instagram</th>
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">LinkedIn</th>
				...
				<form enctype="multipart/form-data" action="{{ route('addTeamMember') }}" method="POST" id="commonAddForm">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<label for="langName">Facebook Link</label>
							<input id="commonFbLink" name="commonFbLink" type="text" class="form-control" placeholder="Enter A Service Percentese">
						</div>

						<div class="form-group">

							<label for="langName">Twiter Link</label>
							<input id="commonTwLink" name="commonTwLink" type="text" class="form-control" placeholder="Enter A Service Percentese">
						</div>

						<div class="form-group">

							<label for="langName">Instagram Link</label>
							<input id="commonInLink" name="commonInLink" type="text" class="form-control" placeholder="Enter A Service Percentese">
						</div>
						...
						<div class="form-group">
							...
							<label for="langName">LinkedIn Link</label>
				...
				<form enctype="multipart/form-data" action="{{ route('UpdateTeam') }}" method="POST" id="updateCommonAddForm">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<label for="langName">Twiter Link</label>
							<input id="updateCommonTwLink" name="updateCommonTwLink" type="text" class="form-control" placeholder="Enter A Service Percentese">
						</div>

						<div class="form-group">

							<label for="langName">Instagram Link</label>
							<input id="updateCommonInLink" name="updateCommonInLink" type="text" class="form-control" placeholder="Enter A Service Percentese">
						</div>
